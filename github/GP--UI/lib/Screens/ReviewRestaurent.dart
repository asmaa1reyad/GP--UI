...
Future<void> _saveReview(BuildContext context) async {
    // استخدم هنا بيانات التقييم والتعليق
    final rating = 3.5;
    final comment = "Great food and service!";

    // إجراء طلب HTTP لحفظ التقييم والتعليق
    ...
    if (response.statusCode == 200) {
      // إذا كانت الاستجابة ناجحة، يمكنك تنفيذ أي عمليات إضافية هنا
      ...
      // في حالة فشل الطلب
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to save review!')),
      );
    }
  }
